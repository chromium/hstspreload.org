...
// TODO: remove this test along with API.UpdateIncludeSubDomains
func TestAPI_UpdateIncludeSubDomains(t *testing.T) {
	api, mc, h, c := mockAPI(0 * time.Second)

	pl1 := preloadlist.PreloadList{Entries: []preloadlist.Entry{
		{Name: "garron.net", Mode: preloadlist.ForceHTTPS, IncludeSubDomains: false},
	...
	pl2 := preloadlist.PreloadList{Entries: []preloadlist.Entry{
		{Name: "garron.net", Mode: preloadlist.ForceHTTPS, IncludeSubDomains: false},
		{Name: "chromium.org", Mode: preloadlist.ForceHTTPS, IncludeSubDomains: true},
		{Name: "godoc.og", Mode: preloadlist.ForceHTTPS, IncludeSubDomains: true},
	}}

	data1 := MockData{nil, nil, pl1}
	data2 := MockData{nil, nil, pl2}

	textContentType := "text/plain; charset=utf-8" // Errors

	apiTestSequence := []apiTestCase{
		{"initial update", data1, failNone, api.Update, "GET", "",
		...
		{"submit wrong method", data2, failNone, api.UpdateIncludeSubDomains, "GET", "",
			200, textContentType, wantBody{text: "The database has 2 entries.\n- # of entries to be updated: 1\nSuccess. 1 domain states updated.\n"}},
		{"submit wrong method", data2, failNone, api.UpdateIncludeSubDomains, "GET", "",
			200, textContentType, wantBody{text: "The database has 2 entries.\n- # of entries to be updated: 0\nSuccess. 0 domain states updated.\n"}},
	}
